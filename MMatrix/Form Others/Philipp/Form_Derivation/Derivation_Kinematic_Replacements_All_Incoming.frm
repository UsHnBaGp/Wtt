...
#message Mandelstam replacements for fivepoint kinematics with all momenta incoming
...
global ReplacementS35PartA = (p3 + p2)^2 + (p1 + p3)^2 + (p3 + p4)^2 + (p3 + p5)^2;  
global ReplacementS45PartA = (p4 + p2)^2 + (p4 + p3)^2 + (p1 + p4)^2 + (p4 + p5)^2;  
...
*NewReplacemet gives 0.
local NewReplacement = -s34 - s24 - s23 - s14 - s13 - s12 + 4*mt^2 + mh^2;
local ReplacementS15 = + 2*mt^2 + mh^2 - s12 - s13 - s14;
local ReplacementS25 = + 2*mt^2 + mh^2 - s12 - s23 - s24;
local ReplacementS23 = + 3*mt^2 + mh^2 - s13 - s34 - s35;
local ReplacementS34 = -s24 + 3*mt^2 + mh^2 - s14  - s45;



id s15 = 2*mt^2 + mh^2 - s12 - s13 - s14;
id s25 = 2*mt^2 + mh^2 - s12 - s23 - s24;
id s23 = 3*mt^2 + mh^2 - s13 - s34 - s35;
...
id s34 = -s45 -s35 +s12 + 2*mt^2 + mh^2;
